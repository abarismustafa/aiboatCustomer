                        ...
                        <div className="col-lg-12">
                            ...
                            <div>
                                ...
                                <div className="inviteLink">
                                    <p>{`https://customer.playnif50.com/signup/${props?.refer_id}`}</p>
                                    <button type="button" className="btn btn-primary" onClick={() => handleCopyClic2(props?.refer_id)}>
                                        {copied2 ? 'Copied!' : 'Copy Invitation Link'}
                                    </button>
                                    <Link className="btn btn-primary ml-2" to={`https://customer.playnif50.com/signup/${props?.refer_id}`} target="_blank">
                                        Invitation Link
                                    </Link>
                                </div>
                            </div>
